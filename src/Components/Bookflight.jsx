...
function Bookflight() {
  ...
  return (
    ...
    <button onClick={goModifyflight} className="flex rounded-lg text-white border boder-white justify-center items-center h-10 w-full px-5">
    Modify
    </button>
    </div>
             </div>
                        ...
                        <div className=" flex w-[215px] max-w-full items-start justify-between gap-5  self-start">
                          <div className="flex flex-col self-start">
                            <img
                              loading="lazy"
                              src={qatar}
                              className="aspect-[2.25] rounded-xl border-gray-200 border object-center w-18 h-14 justify-center items-center overflow-hidden "
                            />
                            <div className="text-black text-xs font-light leading-10 self-center ">
                              QATAR airways
                            </div>
      ...
      <div className=" flex w-[215px] max-w-full items-start justify-between gap-5  self-start">
        <div className="flex flex-col self-start">
          <img
            loading="lazy"
            src={qatar}
            className="aspect-[2.25]  border-gray-200 rounded-xl border object-center w-18 h-14 justify-center items-center overflow-hidden "
          />
          <div className="text-black text-xs font-light leading-7 self-center ">
          <h1>
          QATAR airways

...
{/* footer end */}
             ...
             <div className="p-2 md:h-[60px] md:w-w-full h-16 w-full text-center" >
               <div onClick={gobookvisa} className="h-full flex   border p-2.5 duration-300 hover:bg-gray-50 active:bg-gray-100 cursor-pointer bg-white rounded-lg">

...
Find Best Deals For Air Ticket            </span>
        ...
        <section className=" body-font  md:mx-auto ">
         ...
         <div className="p-2 md:h-[60px] md:w-w-full h-16 w-full">
               <div className="h-full flex items-center  border p-2 hover:bg-gray-50 active:bg-gray-100 cursor-pointer bg-white gap-3 rounded-lg">
...
<button onClick={gocontactdetails} className='w-36 py-2  border-2 md:mt-0 mt-3 border-[#699FC9] bg-[#699FC9] text-white rounded-lg'>RS. 20,000/.</button>

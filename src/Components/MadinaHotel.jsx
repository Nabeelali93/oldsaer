...
<div className="flex md:flex-row flex-col-reverse">
          ...
          <div className="p-2  h-[900px] w-full  bg-[#E4F0FF] ">
            <div className="inline">
              ...
              <div className="flex items-center">
                ...
                <Icon height="22" width="22" icon="material-symbols:star" color="gold" />
                <Icon height="22" width="22" icon="material-symbols:star" color="gold" />
                <Icon height="22" width="22" icon="material-symbols:star" color="gold" />
        ...
        <div className="md:w-5/6 w-full">
          <div className="flex justify-around flex-col md:flex-row items-center w-full  ">
            <div className=" border-[1.5px]    justify-between border-[#A5A5A5]  outline-none md:p-5 p-4 mt-10 rounded-lg h-10 md:w-[235px] w-64  md:m-5 m-0 flex items-center  ">
            <Icon height="24" width="24" icon="material-symbols:search" color="#A5A5A5" />


              <input
                type="text"
                placeholder="Search Makkah Hotels "
                className="bg-transparent  placeholder:text-sm outline-none w-40"
                name=""
                id=""
              />
            </div>
            ...
            <h1
              id="heading"
              className=" font-bold text-black  py-8 text-center lg:text-[25px] md:text-[20px]"
            >
              Madina Hotel
            </h1>
            ...
            <input
              ...
              className="border hidden md:block bg-transparent border-[#A5A5A5] placeholder:text-sm outline-none md:p-5 rounded-lg h-10 md:w-[220px] w-40   "
              readOnly
            />
          </div>

      ...
      <div className="md:mt-0  bg-[#699FC9]">
        ...
        <div className="lg:w-1/2  ">
          <div className="grid md:grid-cols-3 grid-cols-1  lg:mx-16 md:mx-16 gap-2 md:gap-1  lg:w-[80%] md:w-[55%]  text-center  leading-tight justify-items-center ">
            <div className=" duration-300 text-white border border-white rounded-lg p-2  hover:bg-blue-200 cursor-pointer  w-28">
              Single
            </div>
            <div className=" duration-300 text-white border border-white rounded-lg p-2  hover:bg-blue-200 cursor-pointer w-28">
              Family
          ...
          <div className="container flex   px-5 py-10 mx-auto">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 ">
              <div className="p-2 md:h-[60px] md:w-w-full h-16 w-full">
                <div className="h-full flex items-center  border p-2 duration-300 hover:bg-gray-50 active:bg-gray-100 cursor-pointer bg-white rounded-lg">
                  <div className="    ml-1 ">
               
                  <Icon icon="fluent-mdl2:city-next-2" color="#699fc9" height="27" width="27"/>
...
/>
             ...
             <div className="p-2 md:h-[60px] md:w-full h-16 w-full " >
               ...
               <div
                 ...
                 className="h-full  flex items-center gap-2 cursor-pointer duration-300 border p-4 bg-white rounded-lg hover:bg-gray-50 active:bg-gray-100"
               >
                 <div className="   flex justify-center p-2 ">
                 <Icon icon="uiw:date"  height="24" width="24" color="#699FC9" />
...
/>
              ...
              <div className="p-2 md:h-[60px] md:w-w-full h-16 w-full">
                <div  onClick={() => dropdown()} className="h-full flex items-center  border duration-300 hover:bg-gray-50 active:bg-gray-100 cursor-pointer bg-white rounded-lg">
                      ...
                      <div class="relative  inline-block text-left mr-10">
                        ...
                        >
                          {adultcount == 0 ? (
                            <button
                              type="button"
                              class="inline-flex w-full justify-center gap-x-1.5 rounded-md  px-3 py-2 text-sm  text-black shadow-sm  "
                              id="menu-button"
                              aria-expanded="true"
                              aria-haspopup="true"
                            >
              ...
              <div className="p-2 md:h-[60px] md:w-w-full h-16 w-full text-center">
                <div
                  onClick={gobookinsurance}
                  className="h-full flex   border p-2.5 duration-300 hover:bg-gray-50 active:bg-gray-100 cursor-pointer bg-white rounded-lg"
                >
      ...
      <div className="flex flex-row flex-wrap md:p-10 p-5 ">
        <div className="flex flex-wrap  w-full justify-between">
          <div className="flex justify-center items-center">
            <h1 className="">
              Insurance <span className="text-[#B3B3B3]">12Found</span>
            </h1>
          </div>

          <div className="flex ">
            <div className="flex border border-[#DADADA] px-5 py-2 cursor-pointer rounded-lg">
              <h1 className="text-sm text-[#A5A5A5]">
        ...
        <div className="flex flex-col justify-center items-center  w-full">
          <div className="flex lg:w-[90%] w-full lg:flex-row flex-col mt-20 bg-white card border border-gray-300 ">
            ...
            <div className="flex flex-col lg:justify-start justify-center items-center  p-7 ">
              <ul>
                <li className="my-3 text-[#699FC9] lg:text-start text-center">
                  See more benefit
                </li>
                <li className="my-3 text-[#A5A5A5] lg:text-start text-center">
                  Coverage Upto
                </li>
                <li className="my-3 lg:text-start text-center">
                  25.000 (Excess $50)
                </li>
                <li className="my-3 text-[#A5A5A5] lg:text-start text-center">
                  Covid 19
            ...
            <div className="flex justify-center items-end p-5 ">
              <div className=" bg-[#699FC9] w-full flex-wrap cursor-pointer px-4 flex justify-center items-center  h-10">
                <span className="text-white sm:text-sm text-xs">
                  Buy Instant policy with rs. 2808.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex lg:w-[90%] w-full lg:flex-row flex-col mt-20 bg-white card border border-gray-300 ">
            ...
            <div className="flex justify-center items-end p-5 ">
              <div className=" bg-[#699FC9] w-full flex-wrap px-4 cursor-pointer flex justify-center items-center  h-10">
                <span className="text-white sm:text-sm text-xs">
                  Buy Instant policy with rs. 2808.
                </span>
              </div>
